...
This is a community-maintained reference documentation repository. The captured documents in `documents/` are not intended for manual editing — they reflect the live content from developer.kiriminaja.com at the time of capture.

## What you can contribute

- **Corrections:** if captured content is factually wrong, [open an issue](https://github.com/ongkipro/kiriminaja-documentation/issues).
...
- `documents/01..10-*/` — captured reference pages. If content is outdated, re-run the capture process instead of hand-editing.
